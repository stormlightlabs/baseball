...
| --------------------- | ------- | ----------------------------------------------------------------------------------------- |
| `/v1/federalleague/*` | R       | Filters all relevant tables to Federal League coverage (1914-1915) via dedicated aliases. |
| `/v1/negroleagues/*`  | R       | Same schema as core endpoints but scoped to Negro Leagues seasons (1935-1949).            |

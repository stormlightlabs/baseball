-- Negro Leagues Plays table
-- Mirrors the structure of the plays table to store Negro Leagues play-by-play data
...
CREATE INDEX idx_negro_leagues_plays_date ON negro_leagues_plays(date);
CREATE INDEX idx_negro_leagues_plays_batteam ON negro_leagues_plays(batteam);
CREATE INDEX idx_negro_leagues_plays_pitteam ON negro_leagues_plays(pitteam);

...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/meta/crosswalk/players": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Local player ID filter",
                        "name": "player_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Retrosheet ID filter",
                        "name": "retro_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "MLBAM person ID filter",
                        "name": "mlbam_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/core.PlayerCrosswalkResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/meta/crosswalk/players/by-mlbam/{mlbam_id}": {
            "get": {
        ...
        "/meta/crosswalk/players/by-player/{player_id}": {
            "get": {
        ...
        "/meta/crosswalk/players/by-retro/{retro_id}": {
            "get": {
        ...
        "/meta/crosswalk/teams": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "integer",
                        "description": "Season year (defaults to current year when all_seasons=false)",
                        "name": "season",
                        "in": "query"
                    },
                    {
                    ...
                    {
                        "type": "string",
                        "description": "Local team ID filter",
                        "name": "team_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Local franchise ID filter",
                        "name": "franchise_id",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "MLBAM team ID filter",
                        "name": "mlbam_team_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/core.TeamCrosswalkResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/meta/crosswalk/teams/by-franchise/{franchise_id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Local franchise ID",
                        "name": "franchise_id",
                        "in": "path",
                        "required": true
                    },
        ...
        "/meta/crosswalk/teams/by-mlbam/{mlbam_team_id}": {
            "get": {
        ...
        "/meta/crosswalk/teams/by-team/{team_id}": {
            "get": {
        ...
        "/mlb/schedule": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Hydrate payload sections (e.g. linescore,team)",
                        "name": "hydrate",
                        "in": "query"
                    }
                ],
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.SalarySummaryResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/core.SalarySummary"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "core.PlayerCrosswalkResponse": {
            "type": "object",
            "properties": {
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.PlayerCrosswalkRow"
                    }
                },
                "total": {
                    "type": "integer"
        ...
        "core.TeamCrosswalkResponse": {
            ...
            "properties": {
                ...
                "rows": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/core.TeamCrosswalkRow"
                    }
                },
                "season": {
                    "type": "integer"
    ...
    "tags": [
        ...
        {
            "description": "Player salary data and trends",
            "name": "salaries"
        }
    ]
}`
